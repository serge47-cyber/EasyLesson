...
3. 'theses': Мають детально та динамічно (від 3 до 6 тез, залежно від багатства та обсягу матеріалу) занурити учня у розуміння характерів та художніх деталей (внутрішні роздоріжжя дійових осіб, соціальний резонанс, емоційний інтелект, катарсис та життєві інсайти). Створи саме стільки тез, скільки потрібно, щоб повністю розкрити тему (від 3 до 6), не обмежуючись штучно цифрой 3. Кожна теза повинна розкривати один чіткий корисний аспект. Метафора є обов'язковою для кожної тези.
...
6. "stepByStepProblems": Масив, що містить від 1 до 3 об'єктів з практичними розрахунковими задачами, складними математичними чи науковими прикладами, маркованими у параграфі питаннями або вправами для покрокового розбору. Обов'язково знайди та покроково розбери реальні вправи, приклади розв'язання, прикладні сценарії або складні концептуальні питання, що містяться в тексті підручника! Якщо в джерелі немає явних прикладів чи задач, змоделюй від 1 до 3 відповідних тематичних практичних завдань високого рівня. Кожен об'єкт у масиві має описувати 'problem' (умова конкретного завдання, прикладу чи питання), 'principles' (головні принципи, закони, корисні закономірності чи формули для вирішення в 1-2 реченнях), та 'steps' (масив кроків розв'язання, де кожен крок має 'title' - назва кроку, 'explanation' - глибокий аналіз та хід думки, та 'result' - конкретний результат або проміжний висновок цього кроку).
